...
Nw = 100; % number of worms
wormarray = int16(zeros(Nt,Nw,2)); % allocate a variable to save x&y positions at every time-step
foodarray = false(Nx,Nx,Nt); % allocate a variable to save the amount of food at every point and time-step
foodarray(:,:,1) = randi([0,1],50); % intial condition of food everywhere at t=1
